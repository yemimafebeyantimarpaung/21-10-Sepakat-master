...
<div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="{{asset('images/deal.jpg')}}" alt="login" class="login-card-img">
          </div>
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description">Buat akun anda</p>
              <!--Form Login-->
                <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <label for="role" class="sr-only">{{ __('E-Mail Address') }}</label>
                            <select name="role" id="role" class="form-control @error('role') is-invalid @enderror" name="role" value="{{ old('role') }}" required autocomplete="notelp" autofocus style="width:100%;"placeholder="role" >Pilih
                              <option value="Supplier">Supllier</option>
                        ...
                        <div class="form-group row mb-0">
                          <div class="col-md-12">
                            <button type="submit" class="btn btn-success login-btn mb-4" style="background-color:#28a745; width:100%;">
                                  ...
                                  <p class="login-card-footer-text">Sudah punya akun? <a href="{{ route('login') }}" class="text-reset" style="color:blue;"><b>Login disini</b>  </a> <br>Kembali Ke  <a href="{{ route('beranda.index') }}" class="text-reset" style="color:blue;"><b>Beranda</b></a></p>
                                </div>
                        </div>
                      </form>
                    </div>
